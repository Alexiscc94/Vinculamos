<?php
	...
	include_once("../app/controller/medoo_initiatives_plan.php");
	$initiative = getInitiativePlan($evaluation[0]["id_iniciativa"]);
	...
	include_once("../app/controller/medoo_initiatives_plan_result.php");
	$myExpectedResults = getVisibleResultsByInitiativePlan($initiative[0]["id"]);

	include_once("../app/controller/medoo_initiatives_plan_impact.php");
	$myExpectedImpacts = getVisibleImpactsByInitiativePlan($initiative[0]["id"]);

	//include_once("../app/controller/medoo_impact_internal.php");
	//$myInternalImpacts = getInternalImpactByInitiativePlan($initiative[0]["id"]);

	//include_once("../app/controller/medoo_impact_external.php");
	//$myExternalImpacts = getExternalImpactByInitiativePlan($initiative[0]["id"]);
	...
	$programas = getProgramsByInitiativePlan($initiative[0]["id"]);

	$programasNombre = "";
	for($i=0; $i<sizeof($programas); $i++) {
		$programasNombre .= trim($programas[$i]["nombre"]);
		if($i < sizeof($programas)-1) {
			$programasNombre .= ",";
		}
	}
	...
	<head>
		<meta charset="utf-8">
	  	...
	  	<link rel="stylesheet" href="../template/dist/css/skins/_all-skins.css">
			...
			<link rel="icon" href="../app/img/logo_solo_sin_fondo.png">
								...
								<div class="box">
									<div class="box-body">
										...
										<?php
											...
											$nombrePrograma = ("" . $programasNombre . "");

										?>
										<p class="box-title" style="font-size:15px;">
											<div class="col-md-12 text-center">
												<img src='http://aiep.vinculamosvm01.cl/vinculamos_v6_aiep/app/img/aiep_chico.png' width='200px'>
											</div>
											<br>

											Estimado/a,
											<br>
											En el marco de las actividades que el CFT desarrolla en su ámbito de acción "<?php echo$nombrePrograma?>",
																...
																case 'CONOCIMIENTO_ORI': ?>
																	...
																	<div class="col-md-12">
																		<table id="tableOriQuestion" class="table table-bordered table-hover">
																			...
																			<tbody>
																				<?php
																				 	for ($j=0; $j < sizeof($myExpectedResults); $j++) { ?>
																						<tr>
																							<td><?php echo $myExpectedResults[$j]['cantidad'] . " " . $myExpectedResults[$j]['resultado'];?></td>
																							<td>
																								<input type="radio" id="CONOCIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CONOCIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="100" required> Si &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CONOCIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CONOCIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="0" required> No &nbsp;&nbsp;&nbsp;
																							</td>
																							<td>
																								<input type="radio" id="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="0" required> 0% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="25" required> 25% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="50" required> 50% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="75" required> 75% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" name="CUMPLIMIENTO_R_<?php echo$myExpectedResults[$j]['id'];?>" value="100" required> 100%
																							</td>
																						</tr>
																				<?php
																				 	}?>
																			...
																			<tbody>
																				<?php
																				 	for ($j=0; $j < sizeof($myExpectedImpacts); $j++) { ?>
																						<tr>
																							<td><?php echo $myExpectedImpacts[$j]['cantidad'] . " " . $myExpectedImpacts[$j]['impacto'];?></td>
																							<td>
																								<input type="radio" id="CONOCIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CONOCIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="100" required> Si &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CONOCIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CONOCIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="0" required> No &nbsp;&nbsp;&nbsp;
																							</td>
																							<td>
																								<input type="radio" id="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="0" required> 0% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="25" required> 25% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="50" required> 50% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="75" required> 75% &nbsp;&nbsp;&nbsp;
																								<input type="radio" id="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" name="CUMPLIMIENTO_I_<?php echo$myExpectedImpacts[$j]['id'];?>" value="100" required> 100%
																							</td>
																						</tr>
																				<?php
																				 	}?>
