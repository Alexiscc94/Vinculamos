<?php
	...
	if(false) {
		...
		echo "<br> data parsed: " . noeliaDecode($_GET["data"]);
	}
	...
	$iniciativa = getInitiativePlan($encuesta[0]["id_iniciativa"]);
														...
														if($preguntas[$i]["tipo_respuesta"] == "Caritas 1 a 5") { ?>
															...
															<div class="row">
																<div class="form-group text-center">
																	<label id="mensaje" class="col-sm-12 col-md-12"> <?php echo$preguntas[$i]["titulo"]?></label>
																	<div class="row col-md-12">
																		<input type="radio" id="<?php echo$idPregunta;?>" name="<?php echo$idPregunta;?>" value="-" required> No aplica <img src="../app/img/icono0.png"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<input type="radio" id="<?php echo$idPregunta;?>" name="<?php echo$idPregunta;?>" value="1" required> 1 <img src="../app/img/icono1.png"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<input type="radio" id="<?php echo$idPregunta;?>" name="<?php echo$idPregunta;?>" value="2" required> 2 <img src="../app/img/icono2.png"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<input type="radio" id="<?php echo$idPregunta;?>" name="<?php echo$idPregunta;?>" value="3" required> 3 <img src="../app/img/icono3.png"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<input type="radio" id="<?php echo$idPregunta;?>" name="<?php echo$idPregunta;?>" value="4" required> 4 <img src="../app/img/icono4.png"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<input type="radio" id="<?php echo$idPregunta;?>" name="<?php echo$idPregunta;?>" value="5" required> 5 <img src="../app/img/icono5.png"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	</div>
																</div>
															</div>
