<?php
	...
	for ($i=0; $i < sizeof($datasRaw); $i++) {
		$myObjetives = getODSByInitiativePlan($datasRaw[$i]["id"]);
	...
	for ($i=0; $i < sizeof($datas); $i++) {
		...
		$myUnits = getUnitsByInitiativePlan($datas[$i]['id']);
		$datas[$i]['colleges'] = $myUnits;

		// COMENTADO DESDE ANTES
		//$myPrograms = getProgramsByInitiative($datas[$i]['id']);
		//$datas[$i]['programs'] = $myPrograms;

		$myEnvironments = getEnvironmentsByInitiativePlanPOC($datas[$i]["id"]);
		...
		$totalRealParticipation += sumGeneralRealParticipationByInitiative($datas[$i]['id']);
		...
		$resourcesBuilding = sumBuildingResourcesByInitiativePlan($datas[$i]['id']);
		$totalResourcesBuilding += $resourcesBuilding;
		$resourcesFinancial = sumCashResourcesByInitiativePlan($datas[$i]['id']);
		$totalResourcesFinancial += $resourcesFinancial;
		$resourcesHuman = sumHumanResourcesByInitiativePlan($datas[$i]['id']);
	...
	$allUnits = getVisibleUnitsByInstitution($institution);
	$allUnitsCont = array();
			...
			<div class="tab-content">
				<div class="tab-pane active" id="subtab_1Repor1">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-4">
								<h4>Participantes reales: <?php echo $totalRealParticipation;?></h4>
		                ...
		                <li>
		                  	...
		                  	<span class="pull-right text-blue">
			                	...
			                	<span class="pull-right text-blue">
										...
										<li>
											<a href="#">Sin especificar
			                	<span class="pull-right text-blue">
													<?php $genderWithoutData =
														$totalRealParticipation - $totalRealParticipationMan - $totalRealParticipationWoman - $totalRealParticipationOther;
													?>
													<?php echo number_format($genderWithoutData, '0', ',','.');?>
													<?php echo " (" . round($genderWithoutData/$totalRealParticipation * 100, 0) . "%)";?>
												</span>
											</a>
										</li>
		              </ul>
		              ...
		              <ul class="nav nav-pills nav-stacked">
		                ...
		                <li>
		                  	...
		                  	<span class="pull-right text-blue">
			                	...
			                	<span class="pull-right text-blue">
													<?php $ageWithoutData =
														$totalRealParticipation - $totalRealParticipationBoys - $totalRealParticipationYoung - $totalRealParticipationAdult - $totalRealParticipationMayor;
													?>
													<?php echo number_format($ageWithoutData, '0', ',','.');?>
													<?php echo " (" . round($ageWithoutData/$totalRealParticipation * 100, 0) . "%)";?>
												</span>
											</a>
										</li>
		              </ul>
		              ...
		              <ul class="nav nav-pills nav-stacked">
		                  	...
		                  	<span class="pull-right text-blue">
			                	...
			                	<span class="pull-right text-blue">
													<?php $zoneWithoutData =
														$totalRealParticipation - $totalRealParticipationRural - $totalRealParticipationUrban;
													?>
													<?php echo number_format($zoneWithoutData, '0', ',','.');?>
													<?php echo " (" . round($zoneWithoutData/$totalRealParticipation * 100, 0) . "%)";?>
												</span>
											</a>
										</li>
									</ul>
								      			...
								      			<td><?php echo $datas[$i]['nombre'];?></td>
														...
														<td width="250">
								      					...
								      					if(canUpdateInitiatives()) { ?>
																	...
																	<a href="../initiatives/edit_initiative_plan_step1.php?data=<?php echo$data;?>" class='btn btn-orange btn-sm' title='Editar iniciativa'>
								      					...
								      					if(canReadInitiatives()) { ?>
																	<div class="btn-group">
																		<a href="../initiatives/review_initiative_plan.php?data=<?php echo$data;?>" class='btn btn-orange btn-sm' title='Ver iniciativa'>
																		...
																		<a href="../initiatives/view_evidences.php?data=<?php echo$data;?>" class='btn btn-orange btn-sm' title='Ver evidencia'>
