<?php
	...
	$initiatives_count = countInitiativesPlanByInstitution($institucion);
      	...
      	<div class="row">
        	<div class="col-lg-3 col-xs-6">
          	...
          	<div class="small-box bg-aqua">
            	<div class="inner">
              	<h3><?php echo $initiatives_count; ?></h3>
              	<p>Iniciativas</p>
            	</div>
            	<div class="icon">
              	<i class="fa fa-briefcase"></i>
            	</div>
            	<a href="../initiatives/view_initiatives_plan.php" class="small-box-footer">Más info <i class="fa fa-arrow-circle-right"></i></a>
          	</div>
        	</div>
      		<!-- ./col -->
      		<div class="col-lg-3 col-xs-6">
        			...
        			<div class="small-box bg-green">
          			<div class="inner">
            				<h3><?php echo sizeof($units); ?></h3>
            				<p>Escuela</p>
          			</div>
          			<div class="icon">
            				<i class="fa fa-building"></i>
          			</div>
         				<a href="../parameters/view_units.php" class="small-box-footer">Más info <i class="fa fa-arrow-circle-right"></i></a>
        			</div>
      		</div>
      		<!-- ./col -->
      		<div class="col-lg-3 col-xs-6">
								...
								scales: {
									xAxes: [{
										...
										ticks: {
											autoSkip: false,
											min: 0,
											//fixedStepSize: 1 // comentar a futuro
										},
										scaleLabel: {
											display: true,
