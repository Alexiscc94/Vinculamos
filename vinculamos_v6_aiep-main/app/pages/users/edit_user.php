  						...
  						<div class="row">
								<div class="col-md-6">
									...
									<form class="form-horizontal" method="post" id="edit_user" name="edit_user">
										...
										<div class="form-group">
											<label for="vg_correo_electronico" class="col-sm-4 control-label">Correo Electrónico <span class="text-red">*</span></label>
											<div class="col-sm-8">
												<input type="email" class="form-control" id="vg_correo_electronico" name="vg_correo_electronico"
												placeholder="Correo Electrónico" maxlength="100" required value='<?php echo$datas[0]["correo_electronico"];?>'>
											</div>
										</div>
										<div class="form-group">
