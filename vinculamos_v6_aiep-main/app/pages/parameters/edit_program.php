<?php
	...
	$id_program = str_replace("data", "", noeliaDecode($_GET["data"]));

	include_once("../../controller/medoo_programs.php");
	$datas = getProgram($id_program);
?>
	...
	<div class="content-wrapper">
    	<!-- Content Header (Page header) -->
    		...
    		<ol class="breadcrumb">
      		...
      		<li>Programas</li>
      		<li class="active">Editar programa</li>
    		</ol>
    	</section>
						...
						<div class="box-body">
							<div class="row">
								<div class="col-md-6">
									...
									<form class="form-horizontal" method="post" id="edit_program" name="edit_program">
										<?php echo "<input type='hidden' value='".$_SESSION['nombre_usuario']."' id='vg_usuario' name='vg_usuario' />"; ?>
										<?php echo "<input type='hidden' value='".noeliaEncode($id_program)."' id='vg_id' name='vg_id' />"; ?>
										...
										<div class="modal-footer">
											<a href="view_programs.php" class="btn btn-default" data-dismiss="modal">Ir al listado</a>
...
$("#edit_program").submit(function( event ) {
	$('#edit_program').attr("disabled", true);
	var parametros = $(this).serialize();
	$.ajax({
		type: "POST",
		url: "./ajax_edit_program.php",
		data: parametros,
