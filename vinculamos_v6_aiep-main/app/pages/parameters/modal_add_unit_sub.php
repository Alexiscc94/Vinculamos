<!-- Modal -->
<div class="modal fade" id="addUnitSub" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Nueva sub unidad
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_agregar"></div>
				<form class="form-horizontal" method="post" id="add_unit_sub" name="add_unit_sub">
					...
					<div class="form-group">
						<label for="ht_nombre" class="col-sm-3 control-label">Nombre <span class="text-red">*</span></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="ht_apellido" class="col-sm-3 control-label">Director</label>
						<div class="col-sm-8">
