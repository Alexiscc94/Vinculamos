<?php
	...
	$datas = getVisiblePlanParticipationByInitiative($id_initiative);
								...
								<?php
									if(canUpdateInitiatives()) {
										...
										<a href="#" class='text-yellow' title='Editar'
											...
											data-toggle="modal" data-target="#editParticipationPlan">
										...
										<a href="#" class='text-blue' title='Eliminar'
											...
											data-usuario='<?php echo noeliaEncode($_SESSION["nombre_usuario"]);?>'
											data-toggle="modal" data-target="#deleteParticipationPlan">
