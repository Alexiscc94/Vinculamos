					...
					<div class="timeline-body small">
							...
							<?php
								if($datas[$i]["archivo"] != "") {
									...
									if (strpos($archivo, ".pdf") !== false) {
										echo "<iframe src='$archivo' class='img-thumbnail' width='400'/>";
										echo "<a href='$archivo' target='_blank'> &nbsp; Ver archivo</a>";
									} else {
										echo "<a href='$archivo' target='_blank'>";
										echo "	<img src='$archivo' alt='...' class='img-thumbnail' width='400'>";
										echo "</a>";
							...
							<?php
								...
								if(canUpdateInitiatives()) { ?>
									<a data-toggle="modal" data-target="#editEvidence" class='btn btn-orange btn-sm'
									...
									<a data-toggle="modal" data-target="#deleteEvidence" class='btn btn-blue btn-sm'
										data-id_iniciativa='<?php echo noeliaEncode($datas[$i]['id_iniciativa']);?>'
