<!-- Modal -->
<div class="modal fade" id="editParticipationPlan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Editar participante esperado
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_editar_plan"></div>
				<form class="form-horizontal" method="post" id="edit_participation_plan" name="edit_participation_plan">
...
<script>
	$('#edit_participation_plan #checkbox_modal_sexo').on('change', function() {
		$("#edit_participation_plan #vg_modal_sexo_masculino").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_sexo_femenino").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_sexo_otro").prop('readonly', !this.checked);
	});

	$('#edit_participation_plan #checkbox_modal_edad').on('change', function() {
		$("#edit_participation_plan #vg_modal_edad_ninos").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_edad_jovenes").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_edad_adultos").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_edad_adultos_mayores").prop('readonly', !this.checked);
	});

	$('#edit_participation_plan #checkbox_modal_procedencia').on('change', function() {
		$("#edit_participation_plan #vg_modal_procedencia_rural").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_procedencia_urbano").prop('readonly', !this.checked);
	});

	$('#edit_participation_plan #checkbox_modal_vulnerabilidad').on('change', function() {
		$("#edit_participation_plan #vg_modal_vulnerabilidad_discapacidad").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_vulnerabilidad_pobreza").prop('readonly', !this.checked);
	});

	$('#edit_participation_plan #checkbox_modal_nacionalidad').on('change', function() {
		$("#edit_participation_plan #vg_modal_nacionalidad_chileno").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_nacionalidad_migrante").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_nacionalidad_pueblo").prop('readonly', !this.checked);
	});

	$('#edit_participation_plan #checkbox_modal_etnia').on('change', function() {
		$("#edit_participation_plan #vg_modal_etnia_mapuche").prop('readonly', !this.checked);
		$("#edit_participation_plan #vg_modal_etnia_otro").prop('readonly', !this.checked);
	});
</script>
