<?php
	...
	$initiativa = getInitiativePlan($id_initiative);

	include_once("../../controller/medoo_programs.php");
	$programas = getProgramsByInitiativePlan($id_initiative);
							...
							<div class="box-body">
								<div id="loader"></div><!-- Carga los datos ajax -->
									...
									<div class="col-md-12">
										<div class="row">
											<?php
												$attendancesText = $evaluador[0]["nombre"] . "<" . $evaluador[0]["correo_electronico"] . ">";
											?>
											...
											<?php
												...
												$url = "http://aiep.vinculamosvm01.cl/vinculamos_v6_aiep/public/answer_evaluation.php?data=" . $data;
												$message = $encuesta[0]["correo_mensaje"];
												if($message == "") {
													$message = "Estimado/a,<br>";

													$message .= "En el marco de las actividades que AIEP desarrolla en su ámbito de acción \"$programasNombre\", ";
													...
													$message .= "<img src='http://aiep.vinculamosvm01.cl/vinculamos_v5_aiep/app/img/aiep_chico.png' width='60px'>";
...
<script>
	...
	$("#vinculamos_evaluation").submit(function( event ) {
		...
		$.ajax({
			type: "POST",
			url: "./ajax_send_evaluation_one.php",
			data: parametros,
