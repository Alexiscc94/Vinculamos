<?php
	...
	if(false) {
		...
		echo "<br>vg_total_building: " . $_REQUEST['vg_total_building'];
	...
	if( isset($_REQUEST['vg_initiative']) && isset($_REQUEST['vg_source']) && isset($_REQUEST['vg_type_building'])
		...
		include("../../controller/medoo_params_resource_building.php");
		...
		if($building != null) {
			...
			$result = editBuildingResourcePlan(noeliaDecode($_REQUEST['vg_id']), noeliaDecode($_REQUEST['vg_initiative']),
				noeliaDecode($_REQUEST['vg_source']), $_REQUEST['vg_type_building'], $_REQUEST['vg_amount_building'],
				intval($_REQUEST['vg_total_building']), noeliaDecode($_REQUEST['vg_usuario']));
		}
