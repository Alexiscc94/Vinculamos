...
<div class="box-body table-responsive">
	<table id="table" class="table table-bordered table-hover">
		<thead>
    	<tr>
      	<th style="width:110px">¿Interno o Externo?</th>
				<th style="width:110px">Cuantificador</th>
				<th>Resultado</th>
				<th style="width:200px">Cuantificador alcanzado</th>
 			...
 			<?php
 				for($i=0 ; $i<sizeof($datas) ; $i++) { ?>
      			...
      			<td class=""><?php echo $datas[$i]['resultado'];?></td>
						<td class="text-center"><?php echo $datas[$i]['cantidad_real'];?></td>
						<td>
							<?php
      					...
      					if(canUpdateInitiatives()) { ?>
									<a href="#" class='btn btn-blue btn-sm' title='Editar resultado'
										...
										data-cantidad='<?php echo $datas[$i]['cantidad_real'];?>'
										data-resultado='<?php echo $datas[$i]['resultado'];?>'
										data-usuario='<?php echo $_SESSION["nombre_usuario"];?>'
										data-toggle="modal" data-target="#editResultReal">
