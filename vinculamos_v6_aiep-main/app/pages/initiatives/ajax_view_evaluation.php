<?php
	...
	$initiative = getInitiativePlan($id_initiative);
	...
	$myExpectedResults = getVisibleResultsByInitiativePlan($id_initiative);

	include_once("../../controller/medoo_initiatives_plan_impact.php");
	$myExpectedImpacts = getVisibleImpactsByInitiativePlan($id_initiative);
	...
	$programs = getProgramsByInitiativePlan($id_initiative);
					...
					<div class="col-md-12">
						<?php
							...
							for($i=0; $i<sizeof($programs); $i++) {
								$programasNombre .= trim($programs[$i]["nombre"]);
								if($i < sizeof($programas)-1) {
									$programasNombre .= ",";
								}
							}
							$nombrePrograma = ("<strong>" . $programasNombre . "</strong>");
						...
						<p>
							Estimado/a,
							<br>
							En el marco de las actividades que AIEP desarrolla en su ámbito de acción "<?php echo$nombrePrograma?>",
							...
							<br><br>
							<img src='http://aiep.vinculamosvm01.cl/vinculamos_v5_aiep/app/img/aiep_chico.png' width='60px'>
						</p>
					</div>
