<!-- Modal -->
<div class="modal fade" id="editEvidence" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Editar evidencia
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_editar_evidencia"></div>
				<form class="form-horizontal" method="post" id="edit_evidence" name="edit_evidence">
