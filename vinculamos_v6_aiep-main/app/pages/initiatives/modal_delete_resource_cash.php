<!-- Modal -->
<div class="modal fade" id="deleteCash" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Eliminar dinero
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_eliminar_recurso_financiero"></div>
				<p class="text-center">
					<strong>Se eliminará el recurso seleccionado.<br>¿Desea continuar?</strong>
				</p>
				<form class="form-horizontal" method="post" id="delete_cash" name="delete_cash">
