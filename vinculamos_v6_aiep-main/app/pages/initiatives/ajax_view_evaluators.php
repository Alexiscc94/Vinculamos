					...
					for($i=0 ; $i<sizeof($datas) ; $i++) { ?>
						<tr>
							...
							<td>
								...
								?>
								<a href="send_evaluation_one.php?data=<?php echo$data;?>" class="btn btn-orange btn-sm" data-dismiss="modal"> <i class="fa fa-send"></i> </a>

								<?php
									if(canUpdateInitiatives()) {
										$data = base64_encode("data" . $datas[$i]['id']); ?>
										<a href="#" class='btn btn-orange btn-sm' title='Eliminar'
