<!-- Modal -->
<div class="modal fade" id="deleteAttendance" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class='glyphicon glyphicon-edit'></i> Eliminar Participante
				</h4>
			</div>
			<div class="modal-body">
				<div id="resultados_modal_eliminar"></div>
				<p class="text-center">
					<strong>Se eliminará el participante seleccionado.<br>¿Desea continuar?</strong>
				</p>
				<form class="form-horizontal" method="post" id="delete_attendance" name="delete_attendance">
