    	...
    	<!-- Sidebar user panel -->
      	<div class='user-panel' style="background-color: #474747;">
        	<div class='pull-left image'>
          		<img src='../../img/aiep_chico.png' alt='User Image'>
        		...
        		if(canReadInitiatives()) { ?>
        			<li class='treeview <?php if($activeMenu == "initiatives") echo "active" ?>'>
          				...
          				<ul class='treeview-menu'>
            				<li><a href='../initiatives/view_initiatives_plan.php'><i class='fa fa-circle-o'></i> Registro de iniciativas</a></li>
            				<?php
        	...
        	<?php
        		if(canReadParameters()) { ?>
        			<li class='treeview <?php if($activeMenu == "parameters") echo "active" ?>'>
          				...
          				<ul class='treeview-menu'>
            				<li><a href='../parameters/view_units.php'><i class='fa fa-circle-o'></i> Escuelas</a></li>
            				<li><a href='../parameters/view_campus.php'><i class='fa fa-circle-o'></i> Sedes</a></li>
										<li><a href='../parameters/view_departments.php'><i class='fa fa-circle-o'></i> Ámbitos de contribución</a></li>
										<li><a href='../parameters/view_programs.php'><i class='fa fa-circle-o'></i> Programas</a></li>
	      			...
	      			<li class='treeview <?php if($activeMenu == "stats") echo "active" ?>'>
	        				...
	        				<ul class='treeview-menu'>
	          				<li><a href='../stats/view_stats.php'><i class='fa fa-circle-o'></i> Análisis según Iniciativas</a></li>
										...
										<li><a href='../stats/view_stats_v2.php'><i class='fa fa-circle-o'></i> Análisis de datos &nbsp; <small class="label label-warning">v2 beta</small> </a></li>
	        				</ul>
	      			</li>
	      	<?php
	      		} ?>
